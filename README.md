...
An educational web app for mapping the world, searching for places, and navigating around Seattle. The app is designed to highlight 4 components: [**Deques**](src/main/java/deques/), [**Autocomplete**](src/main/java/autocomplete/), [**Priority Queues**](src/main/java/minpq/), and [**Seam Finding**](src/main/java/seamfinding/). See the [**Releases**](https://github.com/kevinlin1/huskymaps/releases) for instructions about each project component.
...
- `Moderator` to simulate a content moderation priority queue with "streaming" data using `MinPQ`.
